...
const entries = [
  { id: "1", title: "Sitting with the pattern", date: "Sep 6, 2026", mood: "Thoughtful", moodAccent: "#60a5fa", preview: "The Pull flagged my analytical retreat pattern again today. I noticed myself doing it in real time — shutting down when things got intense. Awareness is the first step…", tags: ["Patterns", "Self-awareness"], words: 312 },
  { id: "2", title: "Something shifted today", date: "Sep 4, 2026", mood: "Positive", moodAccent: "#34d399", preview: "I finally expressed what I needed without over-explaining it. It felt different — cleaner. The Pull's communication profile said I tend to over-qualify, so this was notable…", tags: ["Communication", "Vulnerability"], words: 248 },
  { id: "3", title: "Processing old patterns", date: "Aug 30, 2026", mood: "Reflective", moodAccent: "#e05060", preview: "I've been noticing how I shut down when things get emotionally intense. The Pull's pattern report described it exactly — I retreat into analysis as a protective mechanism…", tags: ["Patterns", "Growth"], words: 195 },
  ...
  { id: "5", title: "What does trust actually feel like for me?", date: "Aug 20, 2026", mood: "Thoughtful", moodAccent: "#60a5fa", preview: "I realised I hold trust at arm's length. The Pull's archetype profile echoes this — the Analytical Connector builds connection through logic before emotion. I want to understand this better…", tags: ["Identity", "Vulnerability"], words: 289 },
