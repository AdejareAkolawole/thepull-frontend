      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: 440 }}>
          ...
          <p style={{ color: "#6b7280", fontSize: 15, marginBottom: 40, lineHeight: 1.6 }}>
            Your personal intelligence is waiting. Sign in to continue your journey.
          </p>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 2 }}>
              <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer", fontSize: 14, color: "#374151" }}>
                <input
                  ...
                  style={{ width: 16, height: 16, accentColor: "#3d0e1a", cursor: "pointer" }}
                />
                Remember me
              </label>
              <Link href="/forgot-password" style={{ fontSize: 14, color: "#374151", textDecoration: "none" }}>
                Forgot password?
              </Link>
            </div>
          ...
          <p style={{ color: "#9ca3af", fontSize: 14, marginTop: 28, textAlign: "center" }}>
            ...
            <Link href="/register" style={{ color: "#0f0a14", fontWeight: 700, textDecoration: "none" }}>
              Sign up
            </Link>
          </p>
        </div>
